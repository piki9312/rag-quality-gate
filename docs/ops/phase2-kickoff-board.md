...
| --- | ---: | --- | --- |
| legacy_match_count | 0 | 2026-03-28 | CI run quality-gate legacy migration check |
| unresolved_legacy_refs | 0 | 2026-03-28 | migrate-cases report in CI artifact |
| strict_only_impacted_case_count | 1 | 2026-03-28 | strict-only impact report in CI artifact |
...
## 5. Strict-only regular pre-check

...
## 7. Synthetic Regression Monthly Log

fail 母数が小さい週の検知力を補完するため、月次で synthetic regression を実行して記録する。
...
| 2026-03-29 | run 23701830709 | legacy migration baseline | pass | https://github.com/piki9312/rag-quality-gate/actions/runs/23701830709 | CI quality-gate workflow の synthetic regression check |
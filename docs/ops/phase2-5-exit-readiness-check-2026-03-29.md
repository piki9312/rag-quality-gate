...
## 6. Residual Risk Closure Status

| risk | closure control | owner | status | evidence |
| --- | --- | --- | --- | --- |
| WS1 計測が sample repo 条件中心 | RC1: Customer Repo Track Log に直近31日以内の計測行 | release owner | resolved (monitoring active) | docs/ops/phase2-5-ws1-baseline-sheet.md 4.1 |
| failure_category 母数が週によって少ない | RC2: Synthetic Regression Monthly Log に直近31日以内の pass 行 | quality owner | resolved (monitoring active) | docs/ops/phase2-5-ws2-failure-review-template.md 7 |
...
- Decision note:
  ...
  - RC1/RC2 の residual risk closure control は pass（監視継続）
